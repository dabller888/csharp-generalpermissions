ExamDiff(TM) Version 1.6e
ExamDiff Copyright 1997-2001 PrestoSoft(TM) ALL RIGHTS RESERVED.

ExamDiff is a freeware Windows 95/98 and Windows NT tool for 
visual file comparison. It has a number of simple and 
convenient features that many users have been asking for 
a long time from a file comparison tool.
...
-Easy editing of the first and second files. ExamDiff will 
 ...
 $FILE (first or second file name), $CURFIFF (number of 
...
shareware ExamDiff Pro. Visit ExamDiff Pro web page to find out:
...
http://www.nisnevich.com/examdiff/examdiff.htm 
